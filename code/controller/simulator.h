...
protected:
    ...
    void performMoveTo(double x, double y, int delay, int duration) override;
...
Q_OBJECT
public:
    explicit MoveToDelegate(Simulator *simulator, double x, double y, int delay, int duration);
    void execute();
    void destroy();
